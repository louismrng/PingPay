...
/// <summary>
/// Handles Signal bot commands and orchestrates responses.
/// Uses the same command parsing and business logic as WhatsApp.
/// </summary>
public class SignalBotService : ISignalBotService
{
    ...
    /// <summary>
    /// Process an incoming Signal message and return a response.
    /// </summary>
    ...
    {
        _logger.LogInformation("Processing Signal message from {Phone}", phoneNumber[..4] + "****");
        ...
        CancellationToken ct)
    {
        ...
        var user = await _userRepository.CreateAsync(new User
        {
            ...
            IsActive = true,
            IsVerified = true // Verified via Signal
        }, ct);
        ...
        _logger.LogInformation("New user registered via Signal: {UserId}", user.Id);
        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                _logger.LogInformation(
                    "Signal transfer initiated: {TxId} from {Sender} to {Recipient}",
        ...
        {
            _logger.LogError(ex, "Signal transfer failed");
